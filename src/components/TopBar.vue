    ...
    <div class="container">
      ...
      <ul class="nav navbar-nav pull-xs-right">
        ...
        <template v-if="isLoggedIn">
          ...
          <li class="nav-item">
            <router-link class="navbar-brand" :to="{name: 'settings'}">
              <img :src="currentUser.image" alt="image" class="user-pic">
              &nbsp;&nbsp;
              {{currentUser.username}}
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="navbar-brand" :to="{name: 'userProfile', params:{slug: currentUser.username}}" active-class="active">
